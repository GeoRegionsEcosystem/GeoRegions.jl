...
`),n("span",{class:"line"},[n("span",null," ---------- ------------ ---------------------------- -------- ------------------------------- ------------")])])])],-1),n("p",null,[s("See the API "),n("a",{href:"/GeoRegions.jl/v7.0.1/api/addreadrm#GeoRegions.GeoRegion-Tuple{AbstractString}"},"here")],-1)])),_:1}),l(i,{label:"tableRectRegions()"},{default:e(()=>a[1]||(a[1]=[n("div",{class:"language-julia vp-adaptive-theme"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"},"julia"),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[n("code",null,[n("span",{class:"line"},[n("span",{style:{"--shiki-light":"#D73A49","--shiki-dark":"#F97583"}},"using"),n("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}}," GeoRegions")]),s(`
`),n("span",{class:"line"},[n("span",{style:{"--shiki-light":"#005CC5","--shiki-dark":"#79B8FF"}},"tableRectRegions"),n("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"()")])])])],-1),n("div",{class:"language- vp-adaptive-theme"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"}),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[n("code",null,[n("span",{class:"line"},[n("span",null,'┌ Warning: 2025-02-13T04:48:26.179 - GeoRegions.jl - The custom file "rectlist.txt" does not exist in /home/runner, use `setupGeoRegions()` to copy templates and empty custom lists to /home/runner.')]),s(`
`),n("span",{class:"line"},[n("span",null,"└ @ GeoRegions ~/work/GeoRegions.jl/GeoRegions.jl/src/georegions/tables.jl:167")]),s(`
`),n("span",{class:"line"},[n("span",null," -------- ------------ ------------------------ -------- ------------------------------ ------------")]),s(`
`),n("span",{class:"line"},[n("span",null,"    ID        Type      Name                     Parent         Bounds [N,S,E,W]            File")]),s(`
`),n("span",{class:"line"},[n("span",null," -------- ------------ ------------------------ -------- ------------------------------ ------------")]),s(`
`),n("span",{class:"line"},[n("span",null,"   GLB     RectRegion   Globe                     GLB      [90.0, -90.0, 360.0, 0.0]     global.txt")]),s(`
...
`),n("span",{class:"line"},[n("span",null,"  GF_TIB   RectRegion   Tibet                     GLB      [50.0, 30.0, 100.0, 75.0]     giorgi.txt")]),s(`
`),n("span",{class:"line"},[n("span",null,"  GF_NAS   RectRegion   North Asia                GLB      [85.0, 50.0, 180.0, 40.0]     giorgi.txt")]),s(`
`),n("span",{class:"line"},[n("span",null," -------- ------------ ------------------------ -------- ------------------------------ ------------")])])])],-1),n("p",null,[s("See the API "),n("a",{href:"/GeoRegions.jl/v7.0.1/api/tables#GeoRegions.tableRectRegions"},"here")],-1)])),_:1}),l(i,{label:"tablePolyRegions()"},{default:e(()=>a[2]||(a[2]=[n("div",{class:"language-julia vp-adaptive-theme"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"},"julia"),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[n("code",null,[n("span",{class:"line"},[n("span",{style:{"--shiki-light":"#D73A49","--shiki-dark":"#F97583"}},"using"),n("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}}," GeoRegions")]),s(`
`),n("span",{class:"line"},[n("span",{style:{"--shiki-light":"#005CC5","--shiki-dark":"#79B8FF"}},"tablePolyRegions"),n("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"()")])])])],-1),n("div",{class:"language- vp-adaptive-theme"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"}),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[n("code",null,[n("span",{class:"line"},[n("span",null,'┌ Warning: 2025-02-13T04:48:26.275 - GeoRegions.jl - The custom file "polylist.txt" does not exist in /home/runner, use `setupGeoRegions()` to copy templates and empty custom lists to /home/runner.')]),s(`
`),n("span",{class:"line"},[n("span",null,"└ @ GeoRegions ~/work/GeoRegions.jl/GeoRegions.jl/src/georegions/tables.jl:292")]),s(`
`),n("span",{class:"line"},[n("span",null," ---------- ------------ ---------------------------- -------- ------------------------------- ------------")]),s(`
`),n("span",{class:"line"},[n("span",null,"     ID         Type      Name                         Parent         Bounds [N,S,E,W]             File")]),s(`
`),n("span",{class:"line"},[n("span",null," ---------- ------------ ---------------------------- -------- ------------------------------- ------------")]),s(`
`),n("span",{class:"line"},[n("span",null,"    GLB      RectRegion   Globe                         GLB       [90.0, -90.0, 360.0, 0.0]     global.txt")]),s(`
...
`),n("span",{class:"line"},[n("span",null,"  AR6_SIO    PolyRegion   Southern Indian Ocean         GLB      [-10.0, -36.0, 110.0, 31.0]     ar6.txt")]),s(`
`),n("span",{class:"line"},[n("span",null,"  AR6_SOO    PolyRegion   Southern Ocean                GLB     [-36.0, -75.0, 180.0, -180.0]    ar6.txt")]),s(`
`),n("span",{class:"line"},[n("span",null," ---------- ------------ ---------------------------- -------- ------------------------------- ------------")])])])],-1),n("p",null,[s("See the API "),n("a",{href:"/GeoRegions.jl/v7.0.1/api/tables#GeoRegions.tablePolyRegions"},"here")],-1)])),_:1}),l(i,{label:"tableTiltRegions()"},{default:e(()=>a[3]||(a[3]=[n("div",{class:"info custom-block"},[n("p",{class:"custom-block-title"},[s('"No predefined '),n("code",null,"TiltRegion"),s('s"')]),n("p",null,[s("There are no predefined "),n("code",null,"TiltRegion"),s("s in GeoRegions.jl, so calling "),n("code",null,"tableTiltRegions()"),s(" will only return the "),n("code",null,"GLB"),s(" GeoRegion.")])],-1),n("div",{class:"language-julia vp-adaptive-theme"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"},"julia"),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[n("code",null,[n("span",{class:"line"},[n("span",{style:{"--shiki-light":"#D73A49","--shiki-dark":"#F97583"}},"using"),n("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}}," GeoRegions")]),s(`
`),n("span",{class:"line"},[n("span",{style:{"--shiki-light":"#005CC5","--shiki-dark":"#79B8FF"}},"tableTiltRegions"),n("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"()")])])])],-1),n("div",{class:"language- vp-adaptive-theme"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"}),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[n("code",null,[n("span",{class:"line"},[n("span",null,'┌ Warning: 2025-02-13T04:48:26.380 - GeoRegions.jl - The custom file "tiltlist.txt" does not exist in /home/runner, use `setupGeoRegions()` to copy templates and empty custom lists to /home/runner.')]),s(`
`),n("span",{class:"line"},[n("span",null,"└ @ GeoRegions ~/work/GeoRegions.jl/GeoRegions.jl/src/georegions/tables.jl:227")]),s(`
`),n("span",{class:"line"},[n("span",null," ----- ------------ ------- -------- --------------------------- ------------")]),s(`
`),n("span",{class:"line"},[n("span",null,"  ID       Type      Name    Parent       Bounds [N,S,E,W]           File")]),s(`
`),n("span",{class:"line"},[n("span",null," ----- ------------ ------- -------- --------------------------- ------------")]),s(`
`),n("span",{class:"line"},[n("span",null,"  GLB   RectRegion   Globe    GLB     [90.0, -90.0, 360.0, 0.0]   global.txt")]),s(`
`),n("span",{class:"line"},[n("span",null," ----- ------------ ------- -------- --------------------------- ------------")])])])],-1),n("p",null,[s("See the API "),n("a",{href:"/GeoRegions.jl/v7.0.1/api/tables#GeoRegions.tableTiltRegions"},"here")],-1)])),_:1})]),_:1})])}const S=p(g,[["render",u]]);export{d as __pageData,S as default};
