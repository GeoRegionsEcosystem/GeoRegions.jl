import{_ as n,c as a,a5 as e,o as i}from"./chunks/framework.D0cFjeDR.js";const h=JSON.parse('{"title":"Default List of Predefined GeoRegions","description":"","frontmatter":{},"headers":[],"relativePath":"basics/listall.md","filePath":"basics/listall.md","lastUpdated":null}'),t={name:"basics/listall.md"};function p(l,s,o,r,c,g){return i(),a("div",null,s[0]||(s[0]=[e(`<h1 id="Default-List-of-Predefined-GeoRegions" tabindex="-1">Default List of Predefined GeoRegions <a class="header-anchor" href="#Default-List-of-Predefined-GeoRegions" aria-label="Permalink to &quot;Default List of Predefined GeoRegions {#Default-List-of-Predefined-GeoRegions}&quot;">​</a></h1><div class="language-@example vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">@example</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>using GeoRegions</span></span>
<span class="line"><span>resetGeoRegions(all=true);</span></span></code></pre></div><h2 id="GeoRegions.jl&#39;s-default-region-is-the-Globe" tabindex="-1">GeoRegions.jl&#39;s default region is the Globe <a class="header-anchor" href="#GeoRegions.jl&#39;s-default-region-is-the-Globe" aria-label="Permalink to &quot;GeoRegions.jl&amp;#39;s default region is the Globe {#GeoRegions.jl&#39;s-default-region-is-the-Globe}&quot;">​</a></h2><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">tableGeoRegions</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(predefined</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">false</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>┌ Warning: 2024-09-08T01:03:49.828 - GeoRegions.jl - The custom file does &quot;rectlist.txt&quot; does not exist in /home/runner, use \`setupGeoRegions()\` to copy templates and empty custom lists to /home/runner</span></span>
<span class="line"><span>└ @ GeoRegions ~/work/GeoRegions.jl/GeoRegions.jl/src/georegions/tables.jl:38</span></span>
<span class="line"><span>┌ Warning: 2024-09-08T01:03:49.828 - GeoRegions.jl - The custom file does &quot;polylist.txt&quot; does not exist in /home/runner, use \`setupGeoRegions()\` to copy templates and empty custom lists to /home/runner</span></span>
<span class="line"><span>└ @ GeoRegions ~/work/GeoRegions.jl/GeoRegions.jl/src/georegions/tables.jl:38</span></span>
<span class="line"><span>┌ Warning: 2024-09-08T01:03:49.828 - GeoRegions.jl - The custom file does &quot;tiltlist.txt&quot; does not exist in /home/runner, use \`setupGeoRegions()\` to copy templates and empty custom lists to /home/runner</span></span>
<span class="line"><span>└ @ GeoRegions ~/work/GeoRegions.jl/GeoRegions.jl/src/georegions/tables.jl:38</span></span>
...
<span class="line"><span> ----- ------------ ------- -------- --------------------------- ------------</span></span></code></pre></div><h2 id="Giorgi-and-Francisco-[2000]" tabindex="-1">Giorgi &amp; Francisco [2000] <a class="header-anchor" href="#Giorgi-and-Francisco-[2000]" aria-label="Permalink to &quot;Giorgi &amp;amp; Francisco [2000] {#Giorgi-and-Francisco-[2000]}&quot;">​</a></h2><p>Add the <code>GF_</code> prefix to the 3-letter IDs given in Giorgi &amp; Francisco [2000] to call GeoRegions adapted from this paper. All GeoRegions are defined as the <code>RectRegion</code> type.</p><div class="tip custom-block"><p class="custom-block-title">Defined in GeoRegions &gt; 1.1</p><p>All <code>GF_*</code> domains are defined only in versions ≥1.1</p></div><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">tableRectRegions</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(giorgi</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">true</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>┌ Warning: 2024-09-08T01:03:49.828 - GeoRegions.jl - The custom file &quot;rectlist.txt&quot; does not exist in /home/runner, use \`setupGeoRegions()\` to copy templates and empty custom lists to /home/runner</span></span>
<span class="line"><span>└ @ GeoRegions ~/work/GeoRegions.jl/GeoRegions.jl/src/georegions/tables.jl:150</span></span>
<span class="line"><span> -------- ------------ ------------------------ -------- ------------------------------ ------------</span></span>
<span class="line"><span>    ID        Type      Name                     Parent         Bounds [N,S,E,W]            File</span></span>
<span class="line"><span> -------- ------------ ------------------------ -------- ------------------------------ ------------</span></span>
<span class="line"><span>   GLB     RectRegion   Globe                     GLB      [90.0, -90.0, 360.0, 0.0]     global.txt</span></span>
...
<span class="line"><span> -------- ------------ ------------------------ -------- ------------------------------ ------------</span></span></code></pre></div><h2 id="SREX-Regions-from-Seneviratne-et-al.-[2012]" tabindex="-1">SREX Regions from Seneviratne et al. [2012] <a class="header-anchor" href="#SREX-Regions-from-Seneviratne-et-al.-[2012]" aria-label="Permalink to &quot;SREX Regions from Seneviratne et al. [2012] {#SREX-Regions-from-Seneviratne-et-al.-[2012]}&quot;">​</a></h2><p>Add the <code>SRX_</code> prefix to the 3-letter IDs given in Seneviratne et al. [2012] to call GeoRegions adapted from this paper. All GeoRegions are defined as the <code>PolyRegion</code> type, even though many of them are rectilinear.</p><div class="tip custom-block"><p class="custom-block-title">Defined in GeoRegions ≧ 2</p><p>All <code>SRX_*</code> domains are defined only in versions ≥2</p></div><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">tablePolyRegions</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(srex</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">true</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>┌ Warning: 2024-09-08T01:03:49.828 - GeoRegions.jl - The custom file &quot;polylist.txt&quot; does not exist in /home/runner, use \`setupGeoRegions()\` to copy templates and empty custom lists to /home/runner</span></span>
<span class="line"><span>└ @ GeoRegions ~/work/GeoRegions.jl/GeoRegions.jl/src/georegions/tables.jl:275</span></span>
<span class="line"><span> --------- ------------ ---------------------------- -------- ------------------------------ ------------</span></span>
<span class="line"><span>    ID         Type      Name                         Parent         Bounds [N,S,E,W]            File</span></span>
<span class="line"><span> --------- ------------ ---------------------------- -------- ------------------------------ ------------</span></span>
<span class="line"><span>    GLB     RectRegion   Globe                         GLB      [90.0, -90.0, 360.0, 0.0]     global.txt</span></span>
...
<span class="line"><span>  SRX_WSA   PolyRegion   West Coast South America      GLB      [0.5, -56.7, 79.7, -82.0]      srex.txt</span></span>
<span class="line"><span>  SRX_ANT   PolyRegion   Antarctica                    GLB     [90.0, -90.0, 180.0, -180.0]    srex.txt</span></span>
...
<span class="line"><span> --------- ------------ ---------------------------- -------- ------------------------------ ------------</span></span></code></pre></div><h2 id="IPCC-AR6-Regions-from-Iturbide-et-al.,-[2020]" tabindex="-1">IPCC AR6 Regions from Iturbide et al., [2020] <a class="header-anchor" href="#IPCC-AR6-Regions-from-Iturbide-et-al.,-[2020]" aria-label="Permalink to &quot;IPCC AR6 Regions from Iturbide et al., [2020] {#IPCC-AR6-Regions-from-Iturbide-et-al.,-[2020]}&quot;">​</a></h2><p>Add the <code>AR6_</code> prefix to the 3-letter IDs given in Iturbide et al., [2020] to call GeoRegions adapted from this paper. All GeoRegions are defined as the <code>PolyRegion</code> type.</p><div class="tip custom-block"><p class="custom-block-title">Defined in GeoRegions ≧ 2</p><p>All <code>AR6_*</code> domains are defined only in versions ≥2</p></div><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">tablePolyRegions</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(ar6</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">true</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>┌ Warning: 2024-09-08T01:03:49.828 - GeoRegions.jl - The custom file &quot;polylist.txt&quot; does not exist in /home/runner, use \`setupGeoRegions()\` to copy templates and empty custom lists to /home/runner</span></span>
<span class="line"><span>└ @ GeoRegions ~/work/GeoRegions.jl/GeoRegions.jl/src/georegions/tables.jl:275</span></span>
<span class="line"><span> ---------- ------------ --------------------------- -------- ------------------------------- ------------</span></span>
<span class="line"><span>     ID         Type      Name                        Parent         Bounds [N,S,E,W]             File</span></span>
<span class="line"><span> ---------- ------------ --------------------------- -------- ------------------------------- ------------</span></span>
...
<span class="line"><span> ---------- ------------ --------------------------- -------- ------------------------------- ------------</span></span></code></pre></div>`,20)]))}const d=n(t,[["render",p]]);export{h as __pageData,d as default};
