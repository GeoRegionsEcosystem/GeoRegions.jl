import{_ as a,c as n,a5 as i,o as e}from"./chunks/framework.JKTEW8jd.js";const r=JSON.parse('{"title":"Is it in a GeoRegion?","description":"","frontmatter":{},"headers":[],"relativePath":"basics/properties/isin.md","filePath":"basics/properties/isin.md","lastUpdated":null}'),p={name:"basics/properties/isin.md"};function t(o,s,l,h,c,d){return e(),n("div",null,s[0]||(s[0]=[i(`<h1 id="Is-it-in-a-GeoRegion?" tabindex="-1">Is it in a GeoRegion? <a class="header-anchor" href="#Is-it-in-a-GeoRegion?" aria-label="Permalink to &quot;Is it in a GeoRegion? {#Is-it-in-a-GeoRegion?}&quot;">​</a></h1><p>When dealing with geographic data, we often wish to check if a point or region is inside another region. GeoRegions.jl allows you to perform this check easily with the function <code>isinGeoRegion</code>.</p><div class="tip custom-block"><p class="custom-block-title">Point Type</p><p>We use the <code>Point</code> Type from the package GeometryBasics.jl, which is reexported by GeoRegions.jl, as an easy way to denote points. This also allows us to use the package PolygonOps.jl to determine if a point is inside a region.</p></div><div class="language-@example vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">@example</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>using GeoRegions</span></span>
...
<span class="line"><span>nothing</span></span></code></pre></div><h2 id="Is-a-Point-in-a-GeoRegion?" tabindex="-1">Is a Point in a GeoRegion? <a class="header-anchor" href="#Is-a-Point-in-a-GeoRegion?" aria-label="Permalink to &quot;Is a Point in a GeoRegion? {#Is-a-Point-in-a-GeoRegion?}&quot;">​</a></h2><p>As an example, let us test if a point is in GeoRegion <code>AR6_EAO</code>, defined in the blue bounding box below. We define the below points:</p><ul><li><p>Point <em>A</em> at coordinates (-20,5)</p></li><li><p>Point <em>B</em> at coordinates (340,5)</p></li><li><p>Point <em>C</em> at coordinates (30,15)</p></li></ul><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">A </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Point</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">-</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">20</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">,</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">5</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">B </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Point</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">340</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">,</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">5</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">C </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Point</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">-</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">45</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">,</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">-</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">7.5</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
...
<span class="line"><span>    Shape      (shape) : Point{2, Float64}[[-34.0, -10.0], [-34.0, 0.0], [-50.0, 0.0], [-50.0, 7.6], [-20.0, 7.6], [8.0, 0.0], [8.0, -10.0], [-34.0, -10.0]]</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>resize_to_layout!(fig)</span></span>
<span class="line"><span>fig</span></span></code></pre></div><p>We see by eye that GeoRegion <code>TS2</code> and <code>TS4</code> are in the <code>BIG</code> region, but the other GeoRegions are not. Now let us verify this with <code>in()</code></p><div class="language-@example vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">@example</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>in(geo_TS1,geo_BIG),</span></span>
<span class="line"><span>in(geo_TS2,geo_BIG),</span></span>
<span class="line"><span>in(geo_TS3,geo_BIG),</span></span>
<span class="line"><span>in(geo_TS4,geo_BIG)</span></span></code></pre></div><p>And we see that this is indeed the case.</p><p>See the API for <code>RectRegion</code> type <a href="/GeoRegions.jl/dev/api/isin#Base.in-Tuple{GeoRegion, RectRegion}">here</a>, and for the <code>TiltRegion</code> and <code>PolyRegion</code> types <a href="/GeoRegions.jl/dev/api/isin#Base.in-Tuple{GeoRegion, Union{PolyRegion, TiltRegion}}">here</a>.</p>`,26)]))}const k=a(p,[["render",t]]);export{r as __pageData,k as default};
