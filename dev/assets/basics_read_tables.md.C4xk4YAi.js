...
`),n("span",{class:"line"},[n("span",null,"  SRX_WSA    PolyRegion   West Coast South America      GLB       [0.5, -56.7, 79.7, -82.0]      srex.txt")]),s(`
`),n("span",{class:"line"},[n("span",null,"  SRX_ANT    PolyRegion   Antarctica                    GLB     [90.0, -90.0, 180.0, -180.0]     srex.txt")]),s(`
...
`),n("span",{class:"line"},[n("span",null," ---------- ------------ ---------------------------- -------- ------------------------------- ------------")])])])],-1)])),_:1}),l(i,{label:"tableRectRegions()"},{default:e(()=>a[1]||(a[1]=[n("div",{class:"language-julia vp-adaptive-theme"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"},"julia"),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[n("code",null,[n("span",{class:"line"},[n("span",{style:{"--shiki-light":"#D73A49","--shiki-dark":"#F97583"}},"using"),n("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}}," GeoRegions")]),s(`
...
`),n("span",{class:"line"},[n("span",null,"└ @ GeoRegions ~/work/GeoRegions.jl/GeoRegions.jl/src/georegions/tables.jl:152")]),s(`
`),n("span",{class:"line"},[n("span",null," -------- ------------ ------------------------ -------- ------------------------------ ------------")]),s(`
`),n("span",{class:"line"},[n("span",null,"    ID        Type      Name                     Parent         Bounds [N,S,E,W]            File")]),s(`
`),n("span",{class:"line"},[n("span",null," -------- ------------ ------------------------ -------- ------------------------------ ------------")]),s(`
`),n("span",{class:"line"},[n("span",null,"   GLB     RectRegion   Globe                     GLB      [90.0, -90.0, 360.0, 0.0]     global.txt")]),s(`
...
`),n("span",{class:"line"},[n("span",null,"  GF_TIB   RectRegion   Tibet                     GLB      [50.0, 30.0, 100.0, 75.0]     giorgi.txt")]),s(`
`),n("span",{class:"line"},[n("span",null,"  GF_NAS   RectRegion   North Asia                GLB      [85.0, 50.0, 180.0, 40.0]     giorgi.txt")]),s(`
`),n("span",{class:"line"},[n("span",null," -------- ------------ ------------------------ -------- ------------------------------ ------------")])])])],-1)])),_:1}),l(i,{label:"tablePolyRegions()"},{default:e(()=>a[2]||(a[2]=[n("div",{class:"language-julia vp-adaptive-theme"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"},"julia"),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[n("code",null,[n("span",{class:"line"},[n("span",{style:{"--shiki-light":"#D73A49","--shiki-dark":"#F97583"}},"using"),n("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}}," GeoRegions")]),s(`
...
`),n("span",{class:"line"},[n("span",null,"└ @ GeoRegions ~/work/GeoRegions.jl/GeoRegions.jl/src/georegions/tables.jl:277")]),s(`
`),n("span",{class:"line"},[n("span",null," ---------- ------------ ---------------------------- -------- ------------------------------- ------------")]),s(`
`),n("span",{class:"line"},[n("span",null,"     ID         Type      Name                         Parent         Bounds [N,S,E,W]             File")]),s(`
`),n("span",{class:"line"},[n("span",null," ---------- ------------ ---------------------------- -------- ------------------------------- ------------")]),s(`
`),n("span",{class:"line"},[n("span",null,"    GLB      RectRegion   Globe                         GLB       [90.0, -90.0, 360.0, 0.0]     global.txt")]),s(`
...
`),n("span",{class:"line"},[n("span",null,"  AR6_SIO    PolyRegion   Southern Indian Ocean         GLB      [-10.0, -36.0, 110.0, 31.0]     ar6.txt")]),s(`
`),n("span",{class:"line"},[n("span",null,"  AR6_SOO    PolyRegion   Southern Ocean                GLB     [-36.0, -75.0, 180.0, -180.0]    ar6.txt")]),s(`
`),n("span",{class:"line"},[n("span",null," ---------- ------------ ---------------------------- -------- ------------------------------- ------------")])])])],-1)])),_:1}),l(i,{label:"tableTiltRegions()"},{default:e(()=>a[3]||(a[3]=[n("div",{class:"tip custom-block"},[n("p",{class:"custom-block-title"},[s("No predefined "),n("code",null,"TiltRegion"),s("s")]),n("p",null,[s("There are no predefined "),n("code",null,"TiltRegion"),s("s in GeoRegions.jl, so calling "),n("code",null,"tableTiltRegions()"),s(" will only return the "),n("code",null,"GLB"),s(" GeoRegion.")])],-1)])),_:1})]),_:1}),a[5]||(a[5]=t(`<div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> GeoRegions</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">tableTiltRegions</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">()</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>┌ Warning: modulelog - The custom file &quot;tiltlist.txt&quot; does not exist in /home/runner, use \`setupGeoRegions()\` to copy templates and empty custom lists to /home/runner</span></span>
<span class="line"><span>└ @ GeoRegions ~/work/GeoRegions.jl/GeoRegions.jl/src/georegions/tables.jl:212</span></span>
...
<span class="line"><span> ----- ------------ ------- -------- --------------------------- ------------</span></span></code></pre></div><p>:::</p>`,3))])}const S=r(R,[["render",u]]);export{B as __pageData,S as default};
